...
class GradeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Grade::Create(['name' => 'الصف السابع', 'level' => 7, 'description' => 'الصف السابع الاعدادي', 'status' => 'active']);
        Grade::Create(['name' => 'الصف الثامن', 'level' => 8, 'description' => 'الصف الثامن الاعدادي', 'status' => 'active']);
        Grade::Create(['name' => 'الصف التاسع', 'level' => 9, 'description' => 'الصف التاسع الاعدادي', 'status' => 'active']);
    }
}
