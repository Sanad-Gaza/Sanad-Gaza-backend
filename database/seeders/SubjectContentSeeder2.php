...
class SubjectContentSeeder2 extends Seeder
{
    public function run(): void
    {
        $subject = Subject::where('grade_id', 2)->where('name', 'رياضيات')->first();
        ...
        $unit3 = Unit::create([
            'subject_id' => $subject->id,
            'title'      => 'الوحدة الثالثة:  الكسور',
        ]);

        Task::create([
            'unit_id'     => $unit3->id,
            'title'       => 'أين اختفت الجزء؟',
